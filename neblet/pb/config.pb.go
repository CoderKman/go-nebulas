...
type MysqlConfig struct {
	...
	MaxIdelConn int32 `protobuf:"varint,5,opt,name=max_idel_conn,json=maxIdelConn,proto3" json:"max_idel_conn,omitempty"`
}
...
func (*MysqlConfig) Descriptor() ([]byte, []int) { return fileDescriptorConfig, []int{2} }
...
func (m *MysqlConfig) GetParams() string {
	if m != nil {
		return m.Params
	}
	return ""
...
func (m *MysqlConfig) GetMaxIdelConn() int32 {
	if m != nil {
		return m.MaxIdelConn
	}
	return 0
}
...
type ChainConfig struct {
	...
	// mysql config
	Mysql *MysqlConfig `protobuf:"bytes,14,opt,name=mysql" json:"mysql,omitempty"`
...
func (m *ChainConfig) GetMysql() *MysqlConfig {
	if m != nil {
		return m.Mysql
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MysqlConfig)(nil), "nebletpb.MysqlConfig")
...
var fileDescriptorConfig = []byte{
	...
	,
}
